	...
	function pintaArticulos(){		
		...
		copiaArticulos.forEach(e => {			
			texto += `<div class="col">
						<div class="card">
							<img src="./assets/${e.codigo}.jpg" class="card-img-top>
							<div class="card-body">
		...
		contenedorArticulos.innerHTML =  texto;
		Array.from(contenedorArticulos.getElementsByTagName('button')).forEach(e=> e.addEventListener("click",ponArticuloEnCarrito));
	...
	window.onload=()=>{
		creaListaCriterios();
		objetoCarro = new Carrito(8968695);
